...
std::ostream& operator<<(std::ostream& os, const float128& x);
...
template<> struct GlmVec2Type<float128> { using type = glm::dvec2; };
...
template<> struct GlmVec3Type<float128> { using type = glm::dvec3; };
